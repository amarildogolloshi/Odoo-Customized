...
zk = zklib.ZKLib("192.168.100.250", 4370)
...
if ret == True:
    ...
    if ( attendance ):
        for lattendance in attendance:
            ...
            print "date %s, Jam %s: %s, Status: %s %s" % ( lattendance[2].date(), lattendance[2].time(), lattendance[0], state,  lattendance[1])
