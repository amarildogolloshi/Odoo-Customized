...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'res.users',
        fields: ['name','nickname','company_id'],
        ...
        model:  'res.users',
        fields: ['name','nickname','pos_security_pin','groups_id','barcode'],
    ...
    // returns the user who is currently the clerk for this point of sale
    get_clerk: function(){
        return this.clerk;
    },
    // changes the current clerk
    set_clerk: function(user){
       this.clerk = user;
    },


    // returns the user who is currently the checker for this point of sale
    get_checker: function(){
        return this.checker;
    },
    // changes the current checker
    set_checker: function(user){
       this.checker = user;
    },
...
exports.Order = Backbone.Model.extend({
    ...
    export_as_JSON: function() {
	    ...
	    sales_clerk: this.pos.clerk ? this.pos.clerk.id : this.pos.user.id,
	    checker : this.pos.checker ? this.pos.checker.id : this.pos.user.id,
            uid: this.uid,
